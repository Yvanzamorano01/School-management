...
const { isAdmin, isStaff, hasPermission } = require('../middleware/roleCheck');
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', auth, isAdmin, hasPermission('Students'), controller.create);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:id', auth, isAdmin, hasPermission('Students'), controller.update);
 ...
 *     description: Remove a student from the system (Admin only)
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id', auth, isAdmin, hasPermission('Students'), controller.delete);
 ...
 *     description: Retrieve academic results for a specific student
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Retrieve fee information and payment history for a specific student
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
