  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden">
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-blue-100">{classData?.code}</p>
            </div>
          </div>
          {classData?.isActive && (
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-gray-50 rounded-lg p-3">
            <div className="flex items-center mb-1">
              <Icon name="Users" size={16} className="text-gray-600 mr-2" />
              <span className="text-xs text-gray-600">Students</span>
            </div>
            <p className="text-lg font-bold text-gray-900">{classData?.totalStudents}</p>
          </div>

          <div className="bg-gray-50 rounded-lg p-3">
            <div className="flex items-center mb-1">
              <Icon name="Layers" size={16} className="text-gray-600 mr-2" />
              <span className="text-xs text-gray-600">Sections</span>
            </div>
            <p className="text-lg font-bold text-gray-900">{classData?.totalSections}</p>
          </div>
        </div>
        ...
        {/* Subjects */}
        <div className="mb-4">
          <p className="text-xs font-medium text-gray-700 mb-2">Subjects ({classData?.subjects?.length || 0})</p>
