...
const ParentSidebar = ({ isCollapsed = false, onToggle }) => {
  ...
  const navigationSections = [
    {
      ...
      items: [
        ...
        { path: '/child-details', label: 'Child Details', icon: 'UserCircle' }
      ]
    },
    {
      title: 'ACADEMICS',
      items: [
        { path: '/child-attendance', label: 'Attendance', icon: 'ClipboardCheck' },
        { path: '/child-results', label: 'Results', icon: 'Award' },
        { path: '/child-timetable', label: 'Timetable', icon: 'Clock' }
      ]
    },
    {
      title: 'FINANCE',
      items: [
        { path: '/child-fees', label: 'Fees', icon: 'CreditCard' }
      ]
    },
    {
      title: 'COMMUNICATION',
