...
const StudentSidebar = ({ isCollapsed = false, onToggle }) => {
  ...
  const navigationSections = [
    ...
    },
    {
      title: 'ACADEMICS',
      items: [
        { path: '/my-results', label: 'My Results', icon: 'Award' },
        { path: '/timetables-management', label: 'Timetable', icon: 'Clock' },
        { path: '/my-attendance', label: 'Attendance', icon: 'ClipboardCheck' }
      ]
    },
    {
      title: 'RESOURCES',
